<template>
    ...
    >
        <div class="d-flex flex-wrap gap-1">
            <p class="mb-0">
                {{ item.anthropogenic_transformation_type }} /
            </p>

            <p class="mb-0">
                {{ item.anthropogenic_transformation_quality }}
            </p>
        </div>
    </div>
...
import MacketModal37_11_WS from "@/components/modals/mackets-modals-sample-area/MacketModal37_11_WS.vue";
export default {
    name: "Macket37_11_WS",
