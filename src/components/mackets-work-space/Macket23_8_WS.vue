<template>
    <MacketModal23_8_WS :params="params"/>

    <button
        type="button"
        class="btn rounded-0 rounded-top btn-light w-100"
        data-bs-toggle="modal"
        data-bs-target="#macket23_8_WS"
    >
...
import MacketModal23_8_WS from "@/components/modals/mackets-modals-sample-area/MacketModal23_8_WS.vue";
export default {
    name: "Macket23_8_WS",
