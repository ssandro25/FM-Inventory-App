...
export default {
    ...
    computed: {
        ...
        macket() {
           ...
           //      .find(item => item.id === parseInt(this.params.forestAreaID)).forestryWS
           //      .find(item => item.id === parseInt(this.params.quarterID)).quarterWS
           //      .find(item => item.id === parseInt(this.params.literID)).literWS
